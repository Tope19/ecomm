        ...
        <div class="container">
            <div class="row">
                <div class="categories__slider owl-carousel">
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="<?php echo base_url(); ?>assets/img/categories/apple.png">
                            <!-- <h5><a href="#">Fresh Fruit</a></h5> -->
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="<?php echo base_url(); ?>assets/img/categories/clevo.png">
                            <!-- <h5><a href="#">Dried Fruit</a></h5> -->
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="<?php echo base_url(); ?>assets/img/categories/toshiba.png">
                            <!-- <h5><a href="#">Vegetables</a></h5> -->
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="<?php echo base_url(); ?>assets/img/categories/asus.png">
                            <!-- <h5><a href="#">drink fruits</a></h5> -->
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="<?php echo base_url(); ?>assets/img/categories/lenovo.jpeg">
                            <!-- <h5><a href="#">drink fruits</a></h5> -->
                        </div>
                    </div>
                </div>
